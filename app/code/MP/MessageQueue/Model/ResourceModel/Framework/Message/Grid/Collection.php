...
namespace MP\MessageQueue\Model\ResourceModel\Framework\Message\Grid;

/**
 * Class Collection
 *
 * @package MP\MessageQueue\Model\ResourceModel\Framework\Message\Grid
 */
class Collection
    extends \Magento\MysqlMq\Model\ResourceModel\MessageCollection
    implements \Magento\Framework\Api\Search\SearchResultInterface
{
    ...
    protected function _construct()
    {
        $this->_init(
            ...
            \Magento\MysqlMq\Model\ResourceModel\Message::class
        );
    }
    ...
    {
        $queueTable              = $this->getTable('queue');
        $queueMessageTable       = $this->getMainTable();
        $queueMessageStatusTable = $this->getTable('queue_message_status');
