...
class Message
    ...
    implements \MP\MessageQueue\Api\Data\MessageInterface, \Magento\Framework\DataObject\IdentityInterface
{
    /**
     * @const string
     */
    const CACHE_TAG = 'mpdb_queue_message';
    ...
    {
        $this->_init(\MP\MessageQueue\Model\ResourceModel\Message::class);
    }
